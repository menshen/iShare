...
- (void)updateBadgeFrame
{
    ...
    self.badge.frame = CGRectMake(self.badgeOriginX, self.badgeOriginY-7, minWidth + padding-1, minHeight + padding-1);
    self.badge.layer.cornerRadius = (minHeight + padding-1) / 2;
...
-(void) setBadgeValue:(NSString *)badgeValue
{
    ...
    if (!badgeValue || [badgeValue isEqualToString:@""] || ([badgeValue isEqualToString:@"0"] && self.shouldHideBadgeAtZero)) {
        ...
        self.badge                      = [[UILabel alloc] initWithFrame:CGRectMake(self.badgeOriginX, self.badgeOriginY, 10, 10)];
        self.badge.textColor            = self.badgeTextColor;
        self.badge.backgroundColor      = self.badgeBGColor;
        self.badge.font                 = self.badgeFont;

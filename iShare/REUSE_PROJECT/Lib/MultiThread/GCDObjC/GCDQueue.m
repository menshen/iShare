...
- (instancetype)initSerial:(char*)QueueName {
    return [self initWithDispatchQueue:dispatch_queue_create(QueueName, DISPATCH_QUEUE_SERIAL)];
}
- (instancetype)initSerial {
  return [self initWithDispatchQueue:dispatch_queue_create(nil, DISPATCH_QUEUE_SERIAL)];
}
- (instancetype)initConcurrent:(char*)QueueName {
    return [self initWithDispatchQueue:dispatch_queue_create(QueueName, DISPATCH_QUEUE_CONCURRENT)];
}

...
+ (void)initialize
{
    ...
    videoIcon       = [UIImage imageNamed:@"uzysAP_ico_assets_video"];
    checkedIcon     = [UIImage imageNamed:@"uzysAP_ico_photo_thumb_check"];
    uncheckedIcon   = [UIImage imageNamed:@"uzysAP_ico_photo_thumb_uncheck"];

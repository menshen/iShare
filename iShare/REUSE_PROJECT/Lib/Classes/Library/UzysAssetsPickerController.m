...
- (void)initNoAssetView
{
    ...
    UIImageView *titleImage = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"uzysAP_ico_no_image"]];
...
- (void)setupCollectionView
{
    ...
    self.collectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 64, ScreenWidth, self.view.bounds.size.height - 64 -48) collectionViewLayout:layout];
...
- (void)showNotAllowed
{
    ...
    UIImageView *locked     = [[UIImageView alloc] initWithImage:[UIImage imageNamed:@"uzysAP_ico_no_access"]];
...
- (void)showNoAssetsIfNeeded
{
    ...
    voidBlock setNoImage = ^{
        ...
        imgView.image = [UIImage imageNamed:@"uzysAP_ico_no_image"];
    ...
    voidBlock setNoVideo = ^{
        UIImageView *imgView = (UIImageView *)[weakSelf.noAssetView viewWithTag:kTagNoAssetViewImageView];
        imgView.image = [UIImage imageNamed:@"uzysAP_ico_no_video"];
        NSLog(@"no video");
        UILabel *title = (UILabel *)[weakSelf.noAssetView viewWithTag:kTagNoAssetViewTitleLabel];

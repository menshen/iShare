...
- (void)setPlaceHolder:(NSString *)placeHolder
{
    ...
    NSUInteger maxChars = [IS_TextView maxCharactersPerLine];
...
{
    return [IS_TextView numberOfLinesForMessage:self.text];
}
...
{
    return (text.length / [IS_TextView maxCharactersPerLine]) + 1;
}

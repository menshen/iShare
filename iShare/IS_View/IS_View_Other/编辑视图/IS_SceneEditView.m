...
@interface IS_SceneEditView()<IS_SenceCreateImageViewDelegate,CMPopTipViewDelegate>
...
@implementation IS_SceneEditView{
...
-(void)showPopView:(id)createImageView {
    ...
    //1.创建新的
//     IS_EditActionView * contentView = [[NSBundle mainBundle]loadNibNamed:@"IS_EditActionView" owner:nil options:nil][0];
...
//    NSInteger change_tag =0;
    if(pan_state == UIGestureRecognizerStateChanged)
    {
        ...
        {
            IS_EditImageView * sence_image_view = self.senceSubViewArray[i];
        ...
        [UIView animateWithDuration:.2  animations:^
         {
             ...
             //结束时将选中view的边框还原
             IS_EditImageView *  beChangeView = self.senceSubViewArray[be_change_tag];

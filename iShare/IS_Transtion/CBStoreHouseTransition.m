...
//            [self.parentViewController.navigationController popViewControllerAnimated:YES];
        ...
        case UIGestureRecognizerStateChanged: {
            ...
            CGFloat progress = [recognizer translationInView:self.parentViewController.view].y / self.parentViewController.view.bounds.size.height / self.percentageAdjustFactor;
            progress = MIN(1.0, MAX(0.0, progress));
            [self updateInteractiveTransition:progress];
            break;
        }
        default:
            if ([recognizer velocityInView:self.parentViewController.view].y >= 0) {

...
- (void)removeHandlerForEvent:(UIControlEvents)event
{
    ...
    NSMutableDictionary *opreations = (NSMutableDictionary*)[self associatedValueForKey:&OperationKey];
    
    if(opreations == nil)
    {
        opreations = [[NSMutableDictionary alloc] init];
        [self associateValue:opreations withKey:&OperationKey];
